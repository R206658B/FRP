...
saved_df = pd.read_csv("C:\\Users\\Charles\\Desktop\\FRP\\encodings.csv")
...
path = "C:\\Users\\Charles\\Desktop\\FRP\\"
...
with st.expander("Create New Attendence Sheet"):
    ...
    if st.button("Create New Attendence Sheet"):
        ...
        df.to_csv("C:\\Users\\Charles\\Desktop\\FRP\\" +
...
df = pd.read_csv("C:\\Users\\Charles\\Desktop\\FRP\\" +
...
while start:
    ...
    if face_names:
        for face_loc, name in zip(face_locations, face_names):
            ...
            with open("C:\\Users\\Charles\\Desktop\\FRP\\" + name_of_attendence_sheet+".csv", 'a') as csv_file:
